...
// Creating a variant configuration for different alert styles
const alertVariants = cva(
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        // Default alert style with subtle background
        default: "bg-background text-foreground",
        // Destructive style for error messages
        destructive:
...
// Alert Title component with appropriate styling
